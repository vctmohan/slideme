...
jQuery.extend({
  ...
  function c(t) {
    var e;
    if ("object" == typeof t)for (var i in t)t[i] && (e = {
      name: i,
      url: t[i]
    }); else e = {name: d(t), url: t};
    var n = b[e.name];
...
function (t, e, i, n) {
  ...
  var Ue = {
    ...
    mousemove: we,
    mouseup: Ce
  }, Be = "mousedown", Fe = "mousemove mouseup";
  c(U, _, {
    handler: function (t) {
      var e = Ue[t.type];
...
SL.config = {
  ...
  THEME_TRANSITIONS: [{id: "slide", title: "Slide"}, {
    ...
    id: "zoom",
    title: "Zoom"
  }, {id: "cube", title: "Cube", deprecated: !0}, {
    id: "page",
    title: "Page",
    deprecated: !0
  }],
  ...
  AJAX_SLIDE_TEMPLATES_LIST: "/slide.com/api/v1/slide_templates.json",
  AJAX_SLIDE_TEMPLATES_CREATE: "/slide.com/api/v1/slide_templates.json",
  AJAX_SLIDE_TEMPLATES_UPDATE: function (t) {
    return "/slide.com/api/v1/slide_templates/" + t + ".json"
  },
  AJAX_SLIDE_TEMPLATES_DELETE: function (t) {
    return "/api/v1/slide_templates/" + t + ".json"
  },
  AJAX_TEAM_SLIDE_TEMPLATES_LIST: "/slide.com/api/v1/team/slide_templates.json",
  AJAX_TEAM_SLIDE_TEMPLATES_CREATE: "/slide.com/api/v1/team/slide_templates.json",
  AJAX_TEAM_SLIDE_TEMPLATES_UPDATE: function (t) {
    return "/slide.com/api/v1/team/slide_templates/" + t + ".json"
  },
...
SL.config.V1 = {
  ...
  THEME_FONTS: [{id: "league", title: "League"}, {
    id: "opensans",
    title: "Open Sans"
...
SL("components").Resizer = Class.extend({
  init: function (t, e) {
    this.domElement = $(t), this.revealElement = this.domElement.closest(".reveal"), this.options = $.extend({
      ...
      useOverlay: !1
    }, e), this.mouse = {x: 0, y: 0}, this.mouseStart = {
      x: 0,
      y: 0
    }, this.origin = {
      x: 0,
    ...
    if (this.isMobileSpeakerView() && (SL.util.device.HAS_TOUCH || window.navigator.pointerEnabled)) {
      ...
      e.get("swipe").set({direction: Hammer.DIRECTION_ALL}), e.get("press").set({threshold: 1e3}), $(t).on("touchstart", function (i) {
        1 === $(i.target).closest(".notes-overflowing").length && (e.stop(), $(t).one("touchend", function (t) {
          ...
          }, n = {x: t.originalEvent.pageX, y: t.originalEvent.pageY};
...
SL("views.themes.edit").Panel = Class.extend({
  ...
  }, {name: "CSS", id: "css", factory: "renderCSS"}, {
    name: "HTML",
    id: "html",
    factory: "renderHTML"
  }, {
